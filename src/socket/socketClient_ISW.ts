...
class SocketClient {
    ...
    reUseClient(socketClient: any, defaultMessage: any){
        logger.info("Interswitch: Re-using PREVIOUS socket connection ---- " );

        if (defaultMessage !== null) {
            logger.info('RE: Sending message to serve r:: ' + this.tid + ' => ' + this.serverHost+':' + this.serverPort + ' ==> Message: ' + defaultMessage)
